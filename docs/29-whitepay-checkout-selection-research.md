...
Follow-up to [27-whitepay-research.md](27-whitepay-research.md); it **corrects one factual
error in doc 17** (see "Correction to doc 17" below) and answers the open coin/network /
conversion questions that fed the recurring spec [28-whitepay-recurring-spec.md](28-whitepay-recurring-spec.md).
