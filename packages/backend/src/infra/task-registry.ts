...
/**
 * TaskRegistry — the in-memory seam where modules subscribe handlers to message
 ...
 * reads this registry to know what it may claim. Kept dependency-free (no SQL) so
 * it stays in the DB-less `AppLayer` and the HTTP app can register handlers
